        ...
        <section className="weather__body">
            ...
            <article className="weather__condition">
                ...
                <ul className="weather__list">
                    <li className="weather__item"><span className="weather__label">Win speed:</span><span className="weather__value">{weather?.wind.speed}m/s</span></li>
                    ...
                    <li className="weather__item"><span className="weather__label">Preassure: </span><span className="weather__value">{weather?.main.pressure}hpa</span></li>
                </ul>
            </article>
        </section>
